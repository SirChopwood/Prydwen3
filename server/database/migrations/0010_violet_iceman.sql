...
INSERT INTO `__new_RRM_Session`("id", "requests", "status", "sources", "start_time", "end_time", "last_user", "owner", "channels") SELECT "id", "requests", "status", "sources", "start_time", "end_time", "last_user", "owner", "channels" FROM `RRM_Session`;--> statement-breakpoint
